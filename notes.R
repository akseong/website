...
## place where you want your table of contents ----
# Table of Contents: {#toc}
```{r echo=FALSE, eval=TRUE}
blogdown_toc(filename="index.en.Rmd", toc_depth = 2)
```
...
# <center>
#   
#   ![caption](https://media.giphy.com/media/qNQFUVIKAt9Ek/giphy.gif "alt-text")
#   
# </center>
